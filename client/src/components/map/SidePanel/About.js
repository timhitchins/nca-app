    ...
    return (
      <div className="about-container">
        ...
        <div>
          ...
          longer timeline of the earthworks phase, which results in more
          activity hours and more emissions. The earthworks stage of the
          project, meaning working with the soil, is the most emission intensive
          because of the heavy-duty equipment being used and the weight of
          materials being carried. Due to data limitations of the permits and
          variability of equipment used on a site, actual emissions associated
          for each site is difficult to predict.
        </div>
      </div>
    );
  }
